...
<div class="flex justify-center">
 ...
 <h1 class="text-xl font-semibold dark:text-slate-400 opacity-75 pt-4">Priority</h1>
    <div class="dark:text-slate-400 grid sm:grid-cols-3 my-2 gap-6">
    ...
    <div class="dark:text-slate-400 grid sm:grid-cols-4 gap-6">
                        ...
                        <tr>
                            ...
                            <div class="modal-box dark:bg-slate-700">
                                ...
                                <div class="modal-action flex gap-4">
                                    ...
                                    <label for="my_modal_{{ $i }}" class="btn">Close!</label>
                                </div>
                            </div>
                            </div>
                            </th>
