...
@section('body')
    ...
    <div class=" dark:text-slate-400 ">
        ...
        <div class="overflow-x-auto">
            <table class="table rounded-lg overflow-x-auto">
                <!-- head -->
                <thead>
                  <tr>
